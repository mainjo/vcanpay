...
public class BillRequest extends BaseJsonRequest<CustomTrade[]> {
    ...
    public static final String endPoint = "MgrPayBillTransDAO/findPaySearchByCustomId";
    ...
    public BillRequest(int method, String endPoint, String requestBody, Response.Listener<CustomTrade[]> listener, Response.ErrorListener errorListener) {
        super(method, endPoint, requestBody, null, listener, errorListener);
    }
